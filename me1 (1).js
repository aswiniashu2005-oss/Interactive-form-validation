document.addEventListener("DOMContentLoaded", () => {
    ...
    // Shared function to update input styling
    ...
    submitbtn.addEventListener("click", (e) => {
        ...
        if (!usernameValid || !passwordValid) {
            ...
            messageRef.textContent = "Login successful!"; // Or your success message
            messageRef.style.color = "#34bd34";
            // Add actual submission here, e.g., form.submit() or fetch()
        }
